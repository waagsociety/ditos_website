...
class SortedselectField extends BaseField {

  public function __construct() {

    $this->type    = 'sortedselect';
    $this->options = array();
  ...
  public function input() {
    ...
    //ik wil $this->options sorteren op value
    //en daar doorheen loopen
    $sorted_options = $this->options();
    asort($sorted_options);

    foreach($sorted_options as $value => $text) {
